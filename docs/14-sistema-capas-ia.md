...
- [ ] WP-4 — IA diretor de capa
- [ ] WP-5 — caminho full-AI
- [ ] WP-6 — Skia 2.0
- [x] **WP-7** — capa **1600×2400 (2:3)**. (Banner 300×250 da vitrine Kiwify = upload manual já existente; opcional, adiar.)
- [ ] WP-8 — QA por visão

> Próximo: **WP-2** (paleta por IA → variedade de cor coerente) e **WP-6** (Skia 2.0 → caixas/selos/scrims
> que preenchem os 2/3 vazios da capa). Depois WP-4/WP-5 (full-AI) e WP-8 (QA por visão).
