...
public interface ISocialPostRepository
{
    ...
    /// <summary>Posts vencidos e ainda planejados (prontos para publicar).</summary>
    Task<IReadOnlyList<SocialPost>> GetDueAsync(DateTime nowUtc, int take, CancellationToken ct = default);
